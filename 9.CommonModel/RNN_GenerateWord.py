...
class TrainNet(object): 
    ...
    def train(self, sess, train_input, train_output): 
        _ = sess.run([self.__optimizer], 
                feed_dict = {self._input_struct: train_input, self._output_label: train_output}) 
...
if __name__ == "__main__": 
    # TODO visual 自定义的可视化，以及accuracy、召回率等基础指标的tensorboard打印 
